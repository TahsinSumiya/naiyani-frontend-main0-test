...
const DatabaseTable = () => {
  ...
  <button
    className='bg-white shadow-lg text-black p-2 rounded-lg border-none cursor-pointer  text-gray-500'
 // Disable if already in asc order
  >
...
// Disable if already in desc order
  >
    ...
    />
              ...
              <div className="flex gap-5 lg:pr-5">
                ...
                <div className="">
                  <IoMdRefreshCircle   className="w-10 h-10 text-gray-400 hover:animate-spin hover:cursor-pointer"/>
